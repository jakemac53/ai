...
description: Learn about common architecture concepts in application design, and how they apply to Flutter.
metadata:
...
This is often described as _layered_ architecture.
...
In Flutter, this applies to [widgets](/resources/glossary#widget)WidgetThe basic building block of a Flutter user interface. [Learn more](/resources/glossary#widget "Learn more about 'Widget' and find related resources.")
in the UI layer as well. You should write
...
Flutter applications should be written in _layers_. Layered architecture is a
...
Every data type in your app should have a [single source of truth](https://en.wikipedia.org/wiki/Single_source_of_truth)
(SSOT).
...
a Dart class might use [getters](https://dart.dev/effective-dart/design#do-use-getters-for-operations-that-conceptually-access-properties)
to derive values from an SSOT field
...
(UDF) refers to a design pattern that helps
...
[chevron\_left\
PreviousArchitecting Flutter apps](/app-architecture) [NextGuide to app architecture\
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-11-7. [View source](https://github.com/flutter/website/blob/main/src/content/app-architecture/concepts.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/app-architecture/concepts&page-source=https://github.com/flutter/website/blob/main/src/content/app-architecture/concepts.md "Report an issue with this page").