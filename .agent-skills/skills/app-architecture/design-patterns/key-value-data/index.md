...
metadata:
  url: https://docs.flutter.dev/app-architecture/design-patterns/key-value-data
...
that follows this one called [Persistent storage architecture: SQL](/app-architecture/design-patterns/sql).
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-10-30. [View source](https://github.com/flutter/website/blob/main/src/content/app-architecture/design-patterns/key-value-data.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/app-architecture/design-patterns/key-value-data&page-source=https://github.com/flutter/website/blob/main/src/content/app-architecture/design-patterns/key-value-data.md "Report an issue with this page").