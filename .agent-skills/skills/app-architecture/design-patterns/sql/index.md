...
metadata:
  url: https://docs.flutter.dev/app-architecture/design-patterns/sql
...
If you need help, you can read the [Persist data with SQLite](/cookbook/persistence/sqlite)
recipe
...
available in [`/examples/app-architecture/todo_data_service/`](https://github.com/flutter/website/tree/main/examples/app-architecture/todo_data_service/).
...
This functionality follows the recommended [Flutter Architecture design](/app-architecture),
...
It follows the [MVVM pattern](/app-architecture/guide#mvvm)
...
like `sqlite3`, `drift` or even cloud storage solutions like
`firebase_database`.
...
It implements the `fetchTodos()`, `createTodo()`, and `deleteTodo()`
methods.
...
as recommended by the [Flutter architecture recommendations](/app-architecture).
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-14. [View source](https://github.com/flutter/website/blob/main/src/content/app-architecture/design-patterns/sql.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/app-architecture/design-patterns/sql&page-source=https://github.com/flutter/website/blob/main/src/content/app-architecture/design-patterns/sql.md "Report an issue with this page").