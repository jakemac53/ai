---
name: plugins-in-flutter-tests
description: Adding plugin as part of your Flutter tests.
metadata:
  url: https://docs.flutter.dev/testing/plugins-in-tests#mock-the-platform-channel
...
or when running [integration tests](/cookbook/testing/integration/introduction).
When running [Dart unit tests](/cookbook/testing/unit/introduction) or
[widget tests](https://api.flutter.dev/flutter/flutter_test/flutter_test-library.html), the host code isn't available.
...
Plugin implementations that [only use Dart](/packages-and-plugins/developing-packages#dart-only-platform-implementations)
...
and provide a way of [mocking](/cookbook/testing/unit/mocking) your own API in tests.
...
If the plugin is a [federated plugin](/packages-and-plugins/developing-packages#federated-plugins),
...
If the plugin uses [platform channels](/platform-integration/platform-channels),
