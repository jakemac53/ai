---
name: capabilities-policies
description: Learn how to adapt your app to the capabilities and policies required by the platform, app store, your company, and so on.
metadata:
  url: https://docs.flutter.dev/ui/adaptive-responsive/capabilities
...
Use a `Capability` class to define what the code _can_ do.
