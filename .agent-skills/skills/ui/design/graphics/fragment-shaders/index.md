---
name: writing-and-using-fragment-shaders
...
Both the Skia and [Impeller](/perf/impeller) backends support writing a
...
and obtained using the [`FragmentProgram`](https://api.flutter.dev/flutter/dart-ui/FragmentProgram-class.html)
API.
...
use the [`FragmentProgram.fromAsset`](https://api.flutter.dev/flutter/dart-ui/FragmentProgram/fromAsset.html)
constructor.
...
one or more [`FragmentShader`](https://api.flutter.dev/flutter/dart-ui/FragmentShader-class.html)
instances.
...
by setting [`Paint.shader`](https://api.flutter.dev/flutter/dart-ui/Paint/shader.html).
For example, when using [`Canvas.drawRect`](https://api.flutter.dev/flutter/dart-ui/Canvas/drawRect.html)

the shader is evaluated for all fragments within the rectangle.
For an API like [`Canvas.drawPath`](https://api.flutter.dev/flutter/dart-ui/Canvas/drawPath.html)
with a stroked path,
the shader is evaluated for all fragments within the stroked line.
Some APIs, such as [`Canvas.drawImage`](https://api.flutter.dev/flutter/dart-ui/Canvas/drawImage.html), ignore the value of the shader.
...
Fragment shaders can also be used with the [`ImageFilter`](https://api.flutter.dev/flutter/dart-ui/ImageFilter-class.html)
API.
...
class or the [`BackdropFilter`](https://api.flutter.dev/flutter/widgets/BackdropFilter-class.html)
class
to apply shaders to already rendered content.
[`ImageFilter`](https://api.flutter.dev/flutter/dart-ui/ImageFilter-class.html)
provides a constructor, [`ImageFilter.shader`](https://api.flutter.dev/flutter/dart-ui/ImageFilter/ImageFilter.shader.html),
for creating an [`ImageFilter`](https://api.flutter.dev/flutter/dart-ui/ImageFilter-class.html)
with a custom fragment shader.


warningWarning

The `ImageFilter` API for custom shaders is only supported by the [Impeller](/perf/impeller)
backend.
...
When using [`ImageFilter`](https://api.flutter.dev/flutter/dart-ui/ImageFilter-class.html)
with [`BackdropFilter`](https://api.flutter.dev/flutter/widgets/BackdropFilter-class.html), a
[`ClipRect`](https://api.flutter.dev/flutter/widgets/ClipRect-class.html) can be
used to limit the area that is affected by the [`ImageFilter`](https://api.flutter.dev/flutter/dart-ui/ImageFilter-class.html). Without a
[`ClipRect`](https://api.flutter.dev/flutter/widgets/ClipRect-class.html)
the [`BackdropFilter`](https://api.flutter.dev/flutter/widgets/BackdropFilter-class.html)
...
are set using the [`FragmentShader.setFloat`](https://api.flutter.dev/flutter/dart-ui/FragmentShader/setFloat.html)
method.
GLSL sampler values, which use the `sampler2D` type,
are set using the [`FragmentShader.setImageSampler`](https://api.flutter.dev/flutter/dart-ui/FragmentShader/setImageSampler.html)
method.
...
you must call [`FragmentShader.setFloat`](https://api.flutter.dev/flutter/dart-ui/FragmentShader/setFloat.html)
once for each value.
...
This uniform is set separately with [`FragmentShader.setImageSampler`](https://api.flutter.dev/flutter/dart-ui/FragmentShader/setImageSampler.html),
...
or [`Picture.toImageSync`](https://api.flutter.dev/flutter/dart-ui/Picture/toImageSync.html).
...
check out [Writing efficient shaders](https://github.com/flutter/flutter/blob/main/docs/engine/impeller/docs/shader_optimization.md)
on GitHub.
...
- [`flutter_shaders`](https://pub.dev/packages/flutter_shaders), a package that simplifies using fragment shaders in Flutter
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-12-4. [View source](https://github.com/flutter/website/blob/main/src/content/ui/design/graphics/fragment-shaders.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/ui/design/graphics/fragment-shaders&page-source=https://github.com/flutter/website/blob/main/src/content/ui/design/graphics/fragment-shaders.md "Report an issue with this page").