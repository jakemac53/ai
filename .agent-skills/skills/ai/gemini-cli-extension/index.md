---
name: flutter-extension-for-gemini-cli
description: Learn how to use the Flutter extension for Gemini CLI to make structured changes to your app at the command line using the Dart and Flutter MCP server.
metadata:
  url: https://docs.flutter.dev/ai/gemini-cli-extension
...
by working through the [Hands on with Gemini](https://codelabs.developers.google.com/gemini-cli-hands-on)
codelab.)
...
[how to build multiplatform apps with Gemini CLI](https://youtu.be/RZPkE5sllck?si=lM0sGs-V6nx7Tw6T):
...
If you find a bug, please [file an issue](https://github.com/gemini-cli-extensions/flutter/issues).


You also might want to check out the
[Gemini CLI extension](https://github.com/gemini-cli-extensions/flutter)
repo.
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-7. [View source](https://github.com/flutter/website/blob/main/src/content/ai/gemini-cli-extension.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/ai/gemini-cli-extension&page-source=https://github.com/flutter/website/blob/main/src/content/ai/gemini-cli-extension.md "Report an issue with this page").