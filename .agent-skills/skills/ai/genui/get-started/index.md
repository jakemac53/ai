...
are described in the [main components](/ai/genui/components) page.
...
Use the following instructions to add [`genui`](https://pub.dev/packages/genui)
to your Flutter app.
The code examples show how to perform the instructions on a brand new
app created by running [`flutter create`](/reference/create-new-app), but you can follow the same
...
- [Google Gemini AI](#180-tab-panel)
- [Firebase AI Logic](#181-tab-panel)
- [GenUI A2UI](#182-tab-panel)
- [Build your own](#183-tab-panel)

The easiest way to start using GenUI is to use the
[`genui_google_generative_ai`](https://pub.dev/packages/genui_google_generative_ai)
package,
...
2. To use this package, you need a Gemini API key.
    ...
    you can get it for free in [Google AI Studio](https://ai.google.dev/aistudio).
...
3. Follow the first three steps in [Firebase's Flutter setup guide](https://firebase.google.com/docs/flutter/setup)

    to add Firebase to your app.

4. Use `dart pub add` to add `genui` and [`genui_firebase_ai`](https://pub.dev/packages/genui_firebase_ai)
    as
...
An integration package for [`genui`](https://pub.dev/packages/genui) and the
[A2UI Streaming UI Protocol](https://a2ui.org/). This package allows
...
1. Set up dependencies:
    Use `dart pub add` to add `genui`, `genui_a2ui`, and
    `a2a` as
    dependencies in your `pubspec.yaml` file.
...
The [example](https://pub.dev/packages/genui_a2ui/example) directory on pub.dev contains a
...
reference `FirebaseAiContentGenerator` (from the [`genui_firebase_ai`](https://pub.dev/packages/genui_firebase_ai)
package)
and `A2uiContentGenerator` (from the [`genui_a2ui`](https://pub.dev/packages/genui_a2ui)
package).
...
[#](#send-messages-and-display-the-agents-responses)
...
Check out the [examples](https://github.com/flutter/genui/blob/main/examples) included in the
`genui` repo.
The [travel app](https://github.com/flutter/genui/blob/main/examples/travel_app)
...
This is why the [earlier example](/ai/genui/get-started#create-the-connection-to-an-agent)
includes
...
[#](#im-getting-errors-about-my-minimum-macosios-version)

Firebase has a [minimum version requirement](https://firebase.google.com/support/release-notes/ios)
...
[chevron\_left\
PreviousGenUI SDK main components & concepts](/ai/genui/components) [NextInput and events\
chevron\_right](/ai/genui/input-events)

Was this page's content helpful?

thumb\_upthumb\_down

Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-5. [View source](https://github.com/flutter/website/blob/main/src/content/ai/genui/get-started.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/ai/genui/get-started&page-source=https://github.com/flutter/website/blob/main/src/content/ai/genui/get-started.md "Report an issue with this page").