---
name: genui-sdk-main-components-and-concepts
description: Familiarize yourself with the main components and concepts of the Flutter for GenUI SDK.
metadata:
  url: https://docs.flutter.dev/ai/genui/components
...
The [`genui`](https://pub.dev/packages/genui) package is built around the following main components:


`GenUiConversation`

The primary facade and entry point for the package.
It includes the `A2uiMessageProcessor` and `ContentGenerator`
classes,
...
check out the [design doc](https://github.com/flutter/genui/blob/main/packages/genui/DESIGN.md).


The next section walks you through adding `genui` to your app.

[chevron\_left\
PreviousGenUI SDK overview](/ai/genui) [NextGet started with the GenUI SDK\
chevron\_right](/ai/genui/get-started)

Was this page's content helpful?

thumb\_upthumb\_down

Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-5. [View source](https://github.com/flutter/website/blob/main/src/content/ai/genui/components.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/ai/genui/components&page-source=https://github.com/flutter/website/blob/main/src/content/ai/genui/components.md "Report an issue with this page").