...
description: How the user will experience the AI Toolkit in your app.
metadata:
  url: https://docs.flutter.dev/ai/ai-toolkit/user-experience
  last_modified: Thu, 22 Jan 2026 01:01:25 GMT
---

# User experience

The [`LlmChatView`](https://pub.dev/documentation/flutter_ai_toolkit/latest/flutter_ai_toolkit/LlmChatView-class.html)
widget is the entry point for the interactive chat
...
input and choose from the **Take Photo**, **Image Gallery**,
**Attach File** and
**Attach Link** icons:
...
When the `LlmChatView` widget is hosted in a [Material app](https://api.flutter.dev/flutter/material/MaterialApp-class.html), it uses
facilities provided by the Material design language, such as Material's
[`TextField`](https://api.flutter.dev/flutter/material/TextField-class.html). Likewise, when hosted in a
[Cupertino app](https://api.flutter.dev/flutter/cupertino/CupertinoApp-class.html), it uses those
facilities, such as [`CupertinoTextField`](https://api.flutter.dev/flutter/cupertino/CupertinoTextField-class.html).
...
`style` property of the `LlmChatView` as described in the [Custom styling](/ai/ai-toolkit/feature-integration#custom-styling)

documentation.


[chevron\_left\
PreviousAI Toolkit overview](/ai/ai-toolkit/) [NextFeature integration\
chevron\_right](/ai/ai-toolkit/feature-integration)

Was this page's content helpful?

thumb\_upthumb\_down

Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-7. [View source](https://github.com/flutter/website/blob/main/src/content/ai/ai-toolkit/user-experience.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/ai/ai-toolkit/user-experience&page-source=https://github.com/flutter/website/blob/main/src/content/ai/ai-toolkit/user-experience.md "Report an issue with this page").