...
description: How to integrate with other Flutter features.
metadata:
  url: https://docs.flutter.dev/ai/ai-toolkit/feature-integration#custom-styling
...
[`LlmChatView`](https://pub.dev/documentation/flutter_ai_toolkit/latest/flutter_ai_toolkit/LlmChatView-class.html), a number of integration points allow your app to blend
...
example](https://github.com/flutter/ai/blob/main/example/lib/welcome/welcome.dart).
...
suggestions, construct the `LlmChatView` with the `suggestions`
parameter:
...
the [suggestions example](https://github.com/flutter/ai/blob/main/example/lib/suggestions/suggestions.dart).
...
give it instructions. For example, the [recipes example app](https://github.com/flutter/ai/tree/main/example/lib/recipes)
uses the
...
`FirebaseProvider`. Check out the [function calling example](https://github.com/flutter/ai/blob/main/example/lib/function_calls/function_calls.dart)
for details.
...
Check out the [custom STT example](https://github.com/flutter/ai/tree/main/example/lib/custom_stt)
for details.
...
`errorMessage`, `onCancelCallback` and `onErrorCallback`
parameters of the
...
The [standard interface that defines all LLM providers](https://pub.dev/documentation/flutter_ai_toolkit/latest/flutter_ai_toolkit/LlmProvider-class.html)
that can
...
To see history in action, check out the [recipes example app](https://github.com/flutter/ai/tree/main/example/lib/recipes)
and the [history\
example app](https://github.com/flutter/ai/blob/main/example/lib/history/history.dart).
...
user requests a recipe in the [recipes example app](https://github.com/flutter/ai/tree/main/example/lib/recipes), the LLM response is used
...
the LLM provider's response text and uses that to implement its `build`
method:
...
`responseMimeType` parameter to `'application/json'` and the
`responseSchema`
...
For example, the [custom styles example app](https://github.com/flutter/ai/blob/main/example/lib/custom_styles/custom_styles.dart)
...
check out the [reference documentation](https://pub.dev/documentation/flutter_ai_toolkit/latest/flutter_ai_toolkit/LlmChatViewStyle-class.html). You can also customize the appearance
...
example](https://github.com/flutter/ai/blob/main/example/lib/styles/styles.dart).


To see custom styles in action, in addition to the [custom styles\
example](https://github.com/flutter/ai/blob/main/example/lib/custom_styles/custom_styles.dart) and the [styles example](https://github.com/flutter/ai/blob/main/example/lib/styles/styles.dart), check out the
[dark\
mode example](https://github.com/flutter/ai/blob/main/example/lib/dark_mode/dark_mode.dart) and the [demo app](https://github.com/flutter/ai#online-demo).
...
interface](https://pub.dev/documentation/flutter_ai_toolkit/latest/flutter_ai_toolkit/LlmProvider-class.html).
...
To see this in action, check out the [Edit Recipe page](https://github.com/flutter/ai/blob/main/example/lib/recipes/pages/edit_recipe_page.dart)
of the recipes
example.
...
[`LlmStreamGenerator`](https://pub.dev/documentation/flutter_ai_toolkit/latest/flutter_ai_toolkit/LlmStreamGenerator.html)
function. You then pass that function to the
...
To see this in action, check out the [logging example app](https://github.com/flutter/ai/blob/main/example/lib/logging/logging.dart).


[chevron\_left\
PreviousUser experience](/ai/ai-toolkit/user-experience) [NextCustom LLM providers\
chevron\_right](/ai/ai-toolkit/custom-llm-providers)

Was this page's content helpful?

thumb\_upthumb\_down

Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-7. [View source](https://github.com/flutter/website/blob/main/src/content/ai/ai-toolkit/feature-integration.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/ai/ai-toolkit/feature-integration&page-source=https://github.com/flutter/website/blob/main/src/content/ai/ai-toolkit/feature-integration.md "Report an issue with this page").