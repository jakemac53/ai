...
metadata:
  url: https://docs.flutter.dev/ai/ai-toolkit/custom-llm-providers
...
- The [Firebase AI Logic provider](https://pub.dev/documentation/flutter_ai_toolkit/latest/flutter_ai_toolkit/FirebaseProvider-class.html),
   which wraps the `firebase_ai` package

- The [Echo provider](https://pub.dev/documentation/flutter_ai_toolkit/latest/flutter_ai_toolkit/EchoProvider-class.html),
...
The [Firebase provider](https://pub.dev/documentation/flutter_ai_toolkit/latest/flutter_ai_toolkit/FirebaseProvider-class.html)
...
check out the [Echo example app](https://github.com/flutter/ai/blob/main/lib/src/providers/implementations/echo_provider.dart), which simply formats
the user's prompt and attachments as Markdown
to send back to the user as its response.


[chevron\_left\
PreviousFeature integration](/ai/ai-toolkit/feature-integration) [NextChat client sample\
chevron\_right](/ai/ai-toolkit/chat-client-sample)

Was this page's content helpful?

thumb\_upthumb\_down

Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-7. [View source](https://github.com/flutter/website/blob/main/src/content/ai/ai-toolkit/custom-llm-providers.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/ai/ai-toolkit/custom-llm-providers&page-source=https://github.com/flutter/website/blob/main/src/content/ai/ai-toolkit/custom-llm-providers.md "Report an issue with this page").