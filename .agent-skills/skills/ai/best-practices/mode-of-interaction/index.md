---
name: mode-of-interaction
description: Learn to balance LLM capabilities with traditional code and implement  guardrails to manage nondeterministic AI behavior.
metadata:
  url: https://docs.flutter.dev/ai/best-practices/mode-of-interaction
...
![Crossword task list showing solved clues in green with confidence percentages and unsolved clues in red](/assets/images/docs/ai-best-practices/crossword-task-list-showing-solved-clues.png)
...
TaskLLM SuitabilityCode Suitability**Parsing the grid for size, contents and clues**Great for an LLM by using vision and language understandingDifficult to write the code to do this**Validating grid contents**Possible to do with another LLM checking the workEasier for a human to glance at and adjust**Handling the task list**An LLM is unlikely to do this consistentlyEasy to write the code to loop through a task list, updating as it goes**Solving each clue**Great for an LLM using language understanding and generationDifficult to do given real world clues that depend on word play, names, and slang**Resolving conflicts**An LLM is inconsistent on this kind of loopingEasy for a human to glance at and adjust
...
[chevron\_left\
PreviousTool calls (aka function calls)](/ai/best-practices/tool-calls) [NextDeveloper experience\
chevron\_right](/ai/best-practices/developer-experience)

Was this page's content helpful?

thumb\_upthumb\_down

Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-7. [View source](https://github.com/flutter/website/blob/main/src/content/ai/best-practices/mode-of-interaction.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/ai/best-practices/mode-of-interaction&page-source=https://github.com/flutter/website/blob/main/src/content/ai/best-practices/mode-of-interaction.md "Report an issue with this page").