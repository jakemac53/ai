---
name: tool-calls-aka-function-calls
description: Learn how to implement tool calling, manage agentic loops, and incorporate  human-in-the-loop interactions using the Firebase AI Logic SDK.
metadata:
...
Here's that algorithm expressed as an extension method on the `GenerativeModel` class so we can call it just like we call
`generateContent`:
...
![App task list showing crossword clues followed by bold answers and confidence scores in parentheses](/assets/images/docs/ai-best-practices/app-task-list-showing-crossword-clues-fo.png)
...
structured output configuration, instead using a tool called `returnResult`
to
...
should take – like "\_R\_Y" – the model wants to suggest an answer that doesn't
fit this pattern – like "RENT". A conflict like this is a good time to ask for
help from the user:

![Crossword Companion app displaying a Conflict Detected dialog asking for user input to resolve a clue pattern](/assets/images/docs/ai-best-practices/crossword-companion-app-displaying-a-con.png)
...
`Completer`](https://api.flutter.dev/flutter/dart-async/Completer-class.html) lets you set some state in your app that puts it into
...
[chevron\_left\
PreviousStructure & output](/ai/best-practices/structure-output) [NextMode of interaction\
chevron\_right](/ai/best-practices/mode-of-interaction)

Was this page's content helpful?

thumb\_upthumb\_down

Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-7. [View source](https://github.com/flutter/website/blob/main/src/content/ai/best-practices/tool-calls.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/ai/best-practices/tool-calls&page-source=https://github.com/flutter/website/blob/main/src/content/ai/best-practices/tool-calls.md "Report an issue with this page").