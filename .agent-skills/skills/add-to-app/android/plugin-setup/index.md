---
name: manage-plugins-and-dependencies-in-add-to-app
...
- Your Flutter module uses a plugin that has an Android
   ...
   [ExoPlayer from the video\_player plugin](https://github.com/flutter/packages/blob/main/packages/video_player/video_player_android/android/build.gradle),
...
[firebase\_crashlytics](https://pub.dev/packages/firebase_crashlytics) plugin require manual
...
[firebase\_crashlytics](https://pub.dev/packages/firebase_crashlytics) via
`pubspec.yaml`:
...
firebase\_crashlytics v0.1.3's own [Gradle file](https://github.com/firebase/flutterfire/blob/bdb95fcacf7cf077d162d2f267eee54a8b0be3bc/packages/firebase_crashlytics/android/build.gradle#L40):
