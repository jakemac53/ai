---
name: flutter-brand-guidelines
description: The guidelines governing the usage of the Flutter trademarks and assets.
metadata:
...
can be found at [Representing the Flutter Brand](https://flutter.dev/brand).
...
3. **\[Unofficial Flutter Events\]** You may use the Flutter trademarks as part of the name
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-10-30. [View source](https://github.com/flutter/website/blob/main/src/content/brand/index.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/brand&page-source=https://github.com/flutter/website/blob/main/src/content/brand/index.md "Report an issue with this page").