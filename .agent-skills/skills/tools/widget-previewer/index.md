...
description: Learn how to use the Flutter Widget Previewer to see your widgets render in real-time, separate from your full app.
metadata:
...
![Flutter Widget Previewer in Android Studio](/assets/images/docs/tools/widget-previewer/android-studio.png)
...
![Flutter Widget Previewer in Visual Studio Code](/assets/images/docs/tools/widget-previewer/vscode.png)
...
you must use the [`@Preview`](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)
...
![Sample widget in Flutter Widget Previewer](/assets/images/docs/tools/widget-previewer/widget-previewer.png)
...
![Filter by previews selected file in Flutter Widget Previewer](/assets/images/docs/tools/widget-previewer/filter-by-file.gif)
...
The [`@Preview`](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)
...
a common set of properties, the [`Preview`](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)
...
Extending the [`Preview`](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)
annotation class also allows for overriding
the [`Preview.transform()`](https://api.flutter.dev/flutter/widget_previews/Preview/transform.html)
...
simple as applying multiple [`@Preview`](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)
...
![Multiple previews in Flutter Widget Previewer](/assets/images/docs/tools/widget-previewer/multi-preview.png)

To simplify creating multiple previews with common configurations, you
can extend the [`MultiPreview`](https://api.flutter.dev/flutter/widget_previews/MultiPreview-class.html)
to create a custom annotation that creates
multiple previews. The following [`MultiPreview`](https://api.flutter.dev/flutter/widget_previews/MultiPreview-class.html)
creates
...
Like [`Preview`](https://api.flutter.dev/flutter/widget_previews/Preview-class.html),
...
- **Unsupported APIs**: Native plugins and any APIs from
  ...
  Widgets with transitive dependencies on `dart:io` will
   ...
   on `dart:ffi` will fail to load completely ( [#166431](https://github.com/flutter/flutter/issues/166431)).

  See the [Dart documentation on conditional imports](https://dart.dev/tools/pub/create-packages#conditionally-importing-and-exporting-library-files)
   for details
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-11-7. [View source](https://github.com/flutter/website/blob/main/src/content/tools/widget-previewer.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/tools/widget-previewer&page-source=https://github.com/flutter/website/blob/main/src/content/tools/widget-previewer.md "Report an issue with this page").