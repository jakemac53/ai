...
widget state](/ui/interactivity#creating-a-stateful-widget),
...
For more information, see [Command-line and server apps](https://dart.dev/server),
[Dart on the server with Dart Frog](https://dartfrog.vgv.dev/),
[Custom Flutter Engine Embedders](https://github.com/flutter/flutter/blob/main/engine/src/flutter/docs/Custom-Flutter-Engine-Embedders.md),
[Dart web server deployment with Heroku](https://www.youtube.com/watch?v=nkTUMVNelXA).
...
and [DevTools Performance view](/tools/devtools/performance).
