---
name: devtools-2-9-1-release-notes
description: Release notes for Dart and Flutter DevTools version 2.9.1.
metadata:
  url: https://docs.flutter.dev/tools/devtools/release-notes/release-notes-2.9.1
...
- Improve support for inspecting large lists and maps in
  ...
  ![Inspection before](/assets/images/docs/tools/devtools/release-notes/images-2.9.1/image1.png)

  ![Inspection after](/assets/images/docs/tools/devtools/release-notes/images-2.9.1/image2.png)
...
- Added an enhanced tooltip for flutter frames -
  ...
  ![Flutter frame tooltips](/assets/images/docs/tools/devtools/release-notes/images-2.9.1/image3.png)
