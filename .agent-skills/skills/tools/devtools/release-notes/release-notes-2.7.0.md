---
name: devtools-2-7-0-release-notes
description: Release notes for Dart and Flutter DevTools version 2.7.0.
metadata:
  url: https://docs.flutter.dev/tools/devtools/release-notes/release-notes-2.7.0
...
- Add an open file dialog (ctrl / cmd + p) -
  ...
  ![Open file dialog](/assets/images/docs/tools/devtools/release-notes/images-2.7.0/image1.gif)

- Add a copy button to the call stack view -
   [#3334](https://github.com/flutter/devtools/pull/3334)

  ![Call stack view](/assets/images/docs/tools/devtools/release-notes/images-2.7.0/image2.png)
...
- Added functionality to load an app startup profile for Flutter apps.
  ...
  ![Profile button](/assets/images/docs/tools/devtools/release-notes/images-2.7.0/image3.png)
  ...
  ![User tag example](/assets/images/docs/tools/devtools/release-notes/images-2.7.0/image4.png)
...
- Added multi-isolate support.
  ...
  ![isolate selector](/assets/images/docs/tools/devtools/release-notes/images-2.7.0/image5.png)

- Add class names to CPU stack frames in the profiler -
   [#3385](https://github.com/flutter/devtools/pull/3385)

  ![Class names](/assets/images/docs/tools/devtools/release-notes/images-2.7.0/image6.png)
