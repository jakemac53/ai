---
name: devtools-2-44-0-release-notes
description: Release notes for Dart and Flutter DevTools version 2.44.0.
metadata:
  url: https://docs.flutter.dev/tools/devtools/release-notes/release-notes-2.44.0
...
- Added offline support for the network screen (thanks to @hrajwade96!) -
  ...
  ![Network profiler controls](/assets/images/docs/tools/devtools/release-notes/images-2.44.0/network_controls.png)

  ![Network profiler open / save button](/assets/images/docs/tools/devtools/release-notes/images-2.44.0/network_open_save_button.png)
