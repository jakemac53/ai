---
name: devtools-2-18-0-release-notes
description: Release notes for Dart and Flutter DevTools version 2.18.0.
metadata:
  url: https://docs.flutter.dev/tools/devtools/release-notes/release-notes-2.18.0
...
- Add 'Rendering time' column to Raster Metrics tab -
  ...
  ![render-time-column](/assets/images/docs/tools/devtools/release-notes/images-2.18.0/render-time-column.png)
...
- Add Profile and Allocation Tracing sub-tabs -
  ...
  ![profile](/assets/images/docs/tools/devtools/release-notes/images-2.18.0/profile.png)

  ![allocation-tracing](/assets/images/docs/tools/devtools/release-notes/images-2.18.0/allocation-tracing.png)
