---
name: devtools-2-23-1-release-notes
description: Release notes for Dart and Flutter DevTools version 2.23.1.
metadata:
  url: https://docs.flutter.dev/tools/devtools/release-notes/release-notes-2.23.1
...
- Added the new verbose logging feature for helping us debug user issues -
  ...
  ![verbose logging](/assets/images/docs/tools/devtools/release-notes/images-2.23.1/verbose-logging.png)
...
- Add a Method Table to the CPU profiler -
  ...
  ![Method table](/assets/images/docs/tools/devtools/release-notes/images-2.23.1/cpu-method-table.png)
