---
name: devtools-2-11-2-release-notes
description: Release notes for Dart and Flutter DevTools version 2.11.2.
metadata:
  url: https://docs.flutter.dev/tools/devtools/release-notes/release-notes-2.11.2
...
- Added the source line number to file uris in CPU profiles -
  ...
  ![cpu stack frame line numbers](/assets/images/docs/tools/devtools/release-notes/images-2.11.2/image1.png)
...
- Added support for auto-scrolling the File Explorer to the selected file -
  ...
  ![debugger file explorer scrolling](/assets/images/docs/tools/devtools/release-notes/images-2.11.2/image2.gif)
