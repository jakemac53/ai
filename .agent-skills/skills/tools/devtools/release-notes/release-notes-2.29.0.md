---
name: devtools-2-29-0-release-notes
description: Release notes for Dart and Flutter DevTools version 2.29.0.
metadata:
  url: https://docs.flutter.dev/tools/devtools/release-notes/release-notes-2.29.0
...
- Added an option in the "Enhance Tracing" menu for tracking platform channel
  ...
  ![Track platform channels setting](/assets/images/docs/tools/devtools/release-notes/images-2.29.0/track_platform_channels.png)
...
- Added an "Open" button to the Performance controls for
  ...
  ![Open file button on the performance screen](/assets/images/docs/tools/devtools/release-notes/images-2.29.0/open_file_performance_screen.png)
