---
name: devtools-2-8-0-release-notes
description: Release notes for Dart and Flutter DevTools version 2.8.0.
metadata:
  url: https://docs.flutter.dev/tools/devtools/release-notes/release-notes-2.8.0
...
- For users on Flutter 2.8.0 or greater (or Dart 2.15.0 or greater),
  ...
  ![dart devtools warning dialog](/assets/images/docs/tools/devtools/release-notes/images-2.8.0/image1.png)
...
- Added a new "Enhance Tracing" feature to help users diagnose UI jank
  ...
  ![Enhance tracing](/assets/images/docs/tools/devtools/release-notes/images-2.8.0/image2.png)
...
![Timeline events](/assets/images/docs/tools/devtools/release-notes/images-2.8.0/image3.png)

- Added new "More debugging options" feature to allow for disabling
   rendering layers for Clip, Opacity, and Physical Shapes.

  ![More debugging options](/assets/images/docs/tools/devtools/release-notes/images-2.8.0/image4.png)
...
- Replaced the "Libraries" pane with a "File Explorer" pane -
  ...
  1. A tree view of the libraries present in your application.
      ...
      or you can use the existing `Ctrl` / `Cmd` +
      `P` keyboard shortcut to search for a file.
...
![Outline view selected library](/assets/images/docs/tools/devtools/release-notes/images-2.8.0/image5.png)
