---
name: devtools-2-20-0-release-notes
description: Release notes for Dart and Flutter DevTools version 2.20.0.
metadata:
  url: https://docs.flutter.dev/tools/devtools/release-notes/release-notes-2.20.0
...
- Add support for grouping samples by tag -
  ...
  ![samples by tag](/assets/images/docs/tools/devtools/release-notes/images-2.20.0/4693.png)

- Enable guidelines for tree view -
   [#4722](https://github.com/flutter/devtools/pull/4722)

  ![guidelines](/assets/images/docs/tools/devtools/release-notes/images-2.20.0/4722.png)
...
- Rename "Profile granularity" to "CPU sampling rate"
  ...
  ![sampling rate](/assets/images/docs/tools/devtools/release-notes/images-2.20.0/4803.png)
...
- Add a new tab, **Diff**, to enable memory leak detection
  ...
  ![diff](/assets/images/docs/tools/devtools/release-notes/images-2.20.0/4714.png)
...
- Add support for displaying coverage in CodeView -
  ...
  ![coverage](/assets/images/docs/tools/devtools/release-notes/images-2.20.0/4700.png)
