---
name: use-the-cpu-profiler-view
description: Learn how to use the DevTools CPU profiler view.
metadata:
  url: https://docs.flutter.dev/tools/devtools/cpu-profiler#flame-chart
...
Use Chrome DevTools to [analyze performance](https://developers.google.com/web/tools/chrome-devtools/evaluate-performance/)
...
![Screenshot of flame chart help](/assets/images/docs/tools/devtools/flame-chart-help.png)
