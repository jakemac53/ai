...
DevTools (see [launch instructions](/tools/devtools#start)).
...
_root_ cause for why a piece of code is included in your
...
For more information, see [App Size Documentation](/perf/app-size#breaking-down-the-size).
...
[App Size Tool tutorial](https://medium.com/@fluttergems/mastering-dart-flutter-devtools-app-size-tool-part-3-of-8-9be6e9ec42a2). Various strategies
