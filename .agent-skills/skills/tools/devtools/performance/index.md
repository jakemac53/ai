...
metadata:
  url: https://docs.flutter.dev/tools/devtools/performance#track-layouts
...
check out [Debugging web performance](/perf/web-performance).
...
**Use a [profile build](/testing/build-modes#profile) of your application to analyze performance.**
...
[Impeller](/perf/impeller) also uses this thread.
...
[Identifying problems in the GPU graph](/perf/ui-performance#identifying-problems-in-the-gpu-graph).
...
check out [Flutter performance profiling](/perf/ui-performance).
...
check out [Reduce shader compilation jank on mobile](/perf/rendering-performance).
...
[Performance View tutorial](https://medium.com/@fluttergems/mastering-dart-flutter-devtools-performance-view-part-8-of-8-4ae762f91230).
