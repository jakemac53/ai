---
name: run-devtools-from-the-command-line
description: Learn how to launch and use DevTools from the command line.
metadata:
  url: https://docs.flutter.dev/tools/devtools/cli
