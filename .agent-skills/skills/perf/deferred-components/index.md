---
name: deferred-components-for-android-and-web
...
- Android's [dynamic feature modules](https://developer.android.com/guide/playcore/feature-delivery)
   deliver the
  ...
  Flutter performs deferred loading when you compile your Android app
   in [release or profile mode](/testing/build-modes), but debug mode treats all
...
how this feature works, see [Deferred Components](https://github.com/flutter/flutter/wiki/Deferred-Components)

on the [Flutter wiki](https://github.com/flutter/flutter/tree/main/docs).
...
1. Add Play Core to the Android app's
...
2. If using the Google Play Store as the
...
3. Opt into deferred components by adding
...
1. The `flutter build appbundle` command
   ...
   and post-gen\_snapshot validation. This is because any
...
4. Assets can also be included by adding
...
5. Manually add all deferred components
...
6. Repeat steps [3.1](#step-3.1) through 3.6 (this step)
...
use Android's [`bundletool`](https://developer.android.com/studio/command-line/bundletool)
to perform
