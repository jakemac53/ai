...
metadata:
  url: https://docs.flutter.dev/perf/ui-performance#the-performance-overlay
...
- **The Performance View**: A web-based interface that connects to your app and
   ...
   more, see [Use the Performance View](/tools/devtools/performance).
...
- **Performance tracing within Dart**: Add tracing directly into your app's
   ...
   performance in the DevTools utility. To learn more, see [Tracing Dart code](/testing/code-debugging#trace-dart-code-performance).
...
- **Benchmarking**: You can measure and track your app's performance by writing
   ...
   and startup time. For more information, check out [Integration testing](/testing/integration-tests).
...
- **Widget rebuild profiler (IntelliJ for Android Studio)**: Jank often arises
   ...
   see [Show performance data](/tools/android-studio#show-performance-data).
...
with your Flutter application running in [profile mode](/testing/build-modes#profile).
...
_You should consider checking performance_
_on the slowest device that your users might reasonably use._
...
DevTools' [Timeline view](/tools/devtools/performance) allows you to investigate the
...
- **DevTools Performance view**: The easiest way to enable the
   PerformanceOverlay widget is from the [Performance view](/tools/devtools/performance)
   in [DevTools](/tools/devtools).
...
- **programmatically**: To enable the overlay programmatically, see
   [Performance overlay](/testing/code-debugging#add-performance-overlay), a section in the
   [Debugging Flutter apps programmatically](/testing/code-debugging) page.
...
The overlay should always be viewed in [profile mode](/testing/build-modes#profile),
since [debug mode](/testing/build-modes#debug) performance is intentionally sacrificed
...
For more information, see the [UIKit](https://developer.apple.com/documentation/uikit)
documentation for iOS,
or the [MainThread](https://developer.android.com/reference/android/support/annotation/MainThread)
...
see [The Framework architecture](https://github.com/flutter/flutter/blob/main/docs/about/The-Framework-architecture.md)
in the
[Flutter wiki](https://github.com/flutter/flutter/tree/main/docs), and the community article,
...
manipulated, a [`RepaintBoundary`](https://api.flutter.dev/flutter/widgets/RepaintBoundary-class.html)
might help.
...
The [`saveLayer`](https://api.flutter.dev/flutter/dart-ui/Canvas/saveLayer.html)
method is one of the most expensive methods in
...
Caching an image with [`RepaintBoundary`](https://api.flutter.dev/flutter/widgets/RepaintBoundary-class.html)
is good,
...
_Because raster cache entries are expensive to_
_construct and take up loads of GPU memory,_
_cache images only where absolutely necessary._
...
- [DevTools](/tools/devtools): performance tooling for Dart and Flutter apps
- [Flutter API](https://api.flutter.dev) docs, particularly the [`PerformanceOverlay`](https://api.flutter.dev/flutter/widgets/PerformanceOverlay-class.html)
   class,
   and the [dart:developer](https://api.flutter.dev/flutter/dart-developer/dart-developer-library.html)
   package
