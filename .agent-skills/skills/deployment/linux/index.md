---
name: build-and-release-a-linux-app-to-the-snap-store
...
for example to [publish to the Snap Store](https://snapcraft.io/store) or an
...
core concepts, take a look at the [Snap documentation](https://snapcraft.io/docs)

and the [Introduction to snapcraft](https://snapcraft.io/blog/introduction-to-snapcraft).
...
has a single application—super\_cool\_app.
...
2. Register the app's name. Registration can be done
...
3. Release the app. After reading the next section
...
[snapcraft.io](https://snapcraft.io/) site:
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-10-30. [View source](https://github.com/flutter/website/blob/main/src/content/deployment/linux.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/deployment/linux&page-source=https://github.com/flutter/website/blob/main/src/content/deployment/linux.md "Report an issue with this page").