---
name: build-and-release-a-macos-app
...
[App Store Connect](https://appstoreconnect.apple.com/) (formerly iTunes Connect).
...
5. On the next page, confirm the details and click **Register**
...
3. Click **+** in the top-left corner of the My Apps page,
    then select **New App**.

4. Fill in your app details in the form that appears.
...
5. Navigate to the application details for your app and select
    **App Information** from the sidebar.

6. In the General Information section, select the Bundle ID
...
2. To view your app's settings, select the **Runner** project in the Xcode
...
check out Flutter's [Supported deployment platforms](/reference/supported-platforms).
...
Read more about iOS versioning at [Core Foundation Keys](https://developer.apple.com/library/archive/documentation/General/Reference/InfoPlistKeyReference/Articles/CoreFoundationKeys.html)
...
1. Review the [macOS App Icon](https://developer.apple.com/design/human-interface-guidelines/macos/icons-and-images/app-icon/)
    guidelines.

2. In the Xcode project navigator, select `Assets.xcassets` in the
...
2. Select **Runner** in the Xcode project navigator, then select the
    **Runner** target in the settings view sidebar.

3. In the Identity section, update the **Version** to the user-facing
    version number you wish to publish.

4. In the Identity section, update the **Build** identifier to a unique
...
2. Open Xcode and select **Product > Archive** to open the archive created
    in the previous step.

3. Click the **Validate App** button. If any issues are reported,
    address them and produce another build. You can reuse the same
    build ID until you upload an archive.

4. After the archive has been successfully validated, click
...
and [Codemagic CLI Tools](https://github.com/codemagic-ci-cd/cli-tools)
executed in a terminal
in the Flutter project directory.


01. Install the Codemagic CLI tools:
...
02. You'll need to generate an [App Store Connect API Key](https://appstoreconnect.apple.com/access/api)
...
03. You need to export or create a Mac App Distribution and a Mac Installer
...
04. Fetch the code signing files from App Store Connect:
...
05. If you do not have a Mac Installer Distribution certificate,
...
06. Fetch the Mac Installer Distribution certificates:
...
07. Set up a new temporary keychain to be used for code signing:
...
08. Now add the fetched certificates to your keychain:
...
09. Update the Xcode project settings to use fetched code signing profiles:
...
15. As mentioned earlier, don't forget to set your login keychain
...
4. Add the email addresses of any internal testers.
...
See [distribution guide](https://help.apple.com/xcode/mac/current/#/dev295cc0fae)
...
1. Select **Pricing and Availability** from the sidebar of your app's
    ...
    [App Store Connect](https://appstoreconnect.apple.com/) and complete the
    required information.

2. Select the status from the sidebar. If this is the first
...
[macOS packaging guide](https://medium.com/@fluttergems/packaging-and-distributing-flutter-desktop-apps-the-missing-guide-part-1-macos-b36438269285).
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-10-30. [View source](https://github.com/flutter/website/blob/main/src/content/deployment/macos.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/deployment/macos&page-source=https://github.com/flutter/website/blob/main/src/content/deployment/macos.md "Report an issue with this page").