---
name: launching-a-jetpack-compose-activity-from-your-flutter-applicati
description: Learn how to launch native Android activities in your Flutter app.
metadata:
  url: https://docs.flutter.dev/platform-integration/android/compose-activity
...
check out [Hosting native Android views](/platform-integration/android/platform-views).
...
1. Add the following to the existing `android` block:
   ...
   Visit the [developer.android.com](https://developer.android.com/jetpack/androidx/releases/compose-kotlin)
    link in the code snippet and
...
6. Modify the generated `MainActivity` class by adding a
...
7. Add a second `Activity` to the bottom of the file, which you
