...
use the [`ListView.builder()`](https://api.flutter.dev/flutter/widgets/ListView/ListView.builder.html)
constructor.
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-10-28. [View source](https://github.com/flutter/website/blob/main/src/content/cookbook/lists/mixed-list.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/cookbook/lists/mixed-list&page-source=https://github.com/flutter/website/blob/main/src/content/cookbook/lists/mixed-list.md "Report an issue with this page").