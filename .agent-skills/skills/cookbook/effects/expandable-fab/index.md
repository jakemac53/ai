...
and configure this widget to animate and position an individual `ActionButton`. The
`ActionButton` is provided as a generic `Widget` called `child`.
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-10-30. [View source](https://github.com/flutter/website/blob/main/src/content/cookbook/effects/expandable-fab.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/cookbook/effects/expandable-fab&page-source=https://github.com/flutter/website/blob/main/src/content/cookbook/effects/expandable-fab.md "Report an issue with this page").