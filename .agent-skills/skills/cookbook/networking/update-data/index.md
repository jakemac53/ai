...
[JSONPlaceholder](https://jsonplaceholder.typicode.com/) using the [`http.put()`](https://pub.dev/documentation/http/latest/http/put.html)
method.
...
For a complete example, see the [Fetch data](/cookbook/networking/fetch-data)
recipe.
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-10-28. [View source](https://github.com/flutter/website/blob/main/src/content/cookbook/networking/update-data.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/cookbook/networking/update-data&page-source=https://github.com/flutter/website/blob/main/src/content/cookbook/networking/update-data.md "Report an issue with this page").