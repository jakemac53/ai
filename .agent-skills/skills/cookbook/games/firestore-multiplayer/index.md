---
name: add-multiplayer-support-using-firestore
description: How to use use Firebase Cloud Firestore to implement multiplayer in your game.
metadata:
...
For those cases, solutions such as Firestore _don't make a good fit_.
Pick a dedicated multiplayer server solution such as [Nakama](https://heroiclabs.com/nakama/).
...
the [`card`](https://github.com/flutter/games/tree/main/templates/card#readme)
...
[Cloud Firestore](https://cloud.google.com/firestore/) is a horizontally scaling,
...
You _don't_ need to write any Dart code in this step.
...
3. Add the Firestore instance to the app.
   ...
   content\_copy
    ...
    you must either [install the `provider` package](https://pub.dev/packages/provider/install)
...
- **The game doesn't communicate with Firebase on macOS.**
  - By default, macOS apps don't have internet access.
     Enable [internet entitlement](/data-and-backend/networking#macos)
     first.
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-10-28. [View source](https://github.com/flutter/website/blob/main/src/content/cookbook/games/firestore-multiplayer.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/cookbook/games/firestore-multiplayer&page-source=https://github.com/flutter/website/blob/main/src/content/cookbook/games/firestore-multiplayer.md "Report an issue with this page").