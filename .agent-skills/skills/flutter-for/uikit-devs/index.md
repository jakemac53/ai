...
check out [Flutter for SwiftUI developers](/get-started/flutter-for/swiftui-devs)
instead.
...
check out [Learning Dart as a Swift Developer](https://dart.dev/guides/language/coming-from/swift-to-dart)
...
On iOS, you can use the [Cupertino widgets](/ui/widgets/cupertino)
...
in the [widget catalog](/ui/widgets/layout).
...
see Collin's answer on [StackOverflow](https://stackoverflow.com/questions/46241071/create-signature-area-for-mobile-app-in-dart-flutter).
...
A good place to find great packages for Flutter is on [pub.dev](https://pub.dev/flutter/packages).
...
[existing plugin](https://pub.dev/flutter), such as [`url_launcher`](https://pub.dev/packages/url_launcher).
...
[platform channel](/platform-integration/platform-channels) to invoke arbitrary iOS code.
...
to [arb](https://github.com/googlei18n/app-resource-bundle) files for translating, and importing them back into the app
...
see the [layout tutorial](/ui/widgets/layout).
...
to produce an interface that adheres to the
...
see the [Cupertino widgets](/ui/widgets/cupertino) gallery.
...
`TextFormField`, you can supply a [`TextEditingController`](https://api.flutter.dev/flutter/widgets/TextEditingController-class.html)
...
use the popular [`http` package](https://pub.dev/packages/http). This abstracts
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-14. [View source](https://github.com/flutter/website/blob/main/src/content/flutter-for/uikit-devs.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/flutter-for/uikit-devs&page-source=https://github.com/flutter/website/blob/main/src/content/flutter-for/uikit-devs.md "Report an issue with this page").