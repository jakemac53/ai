---
name: flutter-concurrency-for-swift-developers
description: Leverage your Swift concurrency knowledge while learning Flutter and Dart.
metadata:
  url: https://docs.flutter.dev/flutter-for/dart-swift-concurrency
...
Next, define the view model and mark it as an [`@Observable`](https://developer.apple.com/documentation/observation/observable())
...
In Flutter, [`FutureBuilder`](https://api.flutter.dev/flutter/widgets/FutureBuilder-class.html)
and
...
[async\_weather](https://github.com/flutter/website/blob/main/examples/resources/dart_swift_concurrency/lib/async_weather.dart)
file on GitHub.
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-14. [View source](https://github.com/flutter/website/blob/main/src/content/flutter-for/dart-swift-concurrency.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/flutter-for/dart-swift-concurrency&page-source=https://github.com/flutter/website/blob/main/src/content/flutter-for/dart-swift-concurrency.md "Report an issue with this page").