---
name: flutter-for-android-developers
description: Learn how to apply Android developer knowledge when building Flutter apps.
metadata:
  url: https://docs.flutter.dev/flutter-for/android-devs
...
check out [Flutter for Jetpack Compose devs](/get-started/flutter-for/compose-devs)
for detailed information about Jetpack Compose
...
Flutter includes the [Material Components](https://m3.material.io/develop/flutter) library.
These are widgets that implement the
[Material Design guidelines](https://m3.material.io/styles). Material Design is a
flexible design system [optimized for all platforms](https://m3.material.io/develop),
including iOS.
...
the [Animations tutorial](/ui/animations/tutorial),
and the [Animations overview](/ui/animations).
...
through native integrations (using [a plugin](https://pub.dev/packages/android_intent)).
...
integration (or use an [existing plugin](https://pub.dev/flutter/)).


To learn how to build a native platform integration,
see [developing packages and plugins](/packages-and-plugins/developing-packages).
...
loop is equivalent to Android's main `Looper`&mdash;that is, the `Looper`
that
...
popular [`http` package](https://pub.dev/packages/http).
...
See [Internationalizing Flutter apps](/ui/internationalization) for more information on this.
...
A good place to find Flutter packages is [pub.dev](https://pub.dev/flutter/packages/).
...
As mentioned in the [Intents](#what-is-the-equivalent-of-an-intent-in-flutter) section,
...
see Collin's answer on [StackOverflow](https://stackoverflow.com/questions/44396075/equivalent-of-relativelayout-in-flutter).
...
see [Retrieve the value of a text field](/cookbook/forms/retrieve-input).
...
The [`image_picker`](https://pub.dev/packages/image_picker) plugin is popular
...
the third-party package, [home\_widget](https://pub.dev/packages/home_widget), you can wire a homescreen widget
...
check the [Add generated previews to your widget picker](https://developer.android.com/develop/ui/compose/glance/generated-previews)
documentation page.
...
[Shared\_Preferences plugin](https://pub.dev/packages/shared_preferences).
...
see the [`firebase_messaging`](https://pub.dev/packages/firebase_messaging)
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2026-1-14. [View source](https://github.com/flutter/website/blob/main/src/content/flutter-for/android-devs.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/flutter-for/android-devs&page-source=https://github.com/flutter/website/blob/main/src/content/flutter-for/android-devs.md "Report an issue with this page").