---
name: differentiate-between-ephemeral-state-and-app-state
...
_This doc introduces app state, ephemeral state,_
_and how you might manage each in a Flutter app._
...
[chevron\_left\
PreviousStart thinking declaratively](/data-and-backend/state-mgmt/declarative) [NextSimple app state management\
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-4-10. [View source](https://github.com/flutter/website/blob/main/src/content/data-and-backend/state-mgmt/ephemeral-vs-app.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/data-and-backend/state-mgmt/ephemeral-vs-app&page-source=https://github.com/flutter/website/blob/main/src/content/data-and-backend/state-mgmt/ephemeral-vs-app.md "Report an issue with this page").