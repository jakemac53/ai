---
name: developing-packages-plugins
description: How to write packages and plugins for Flutter.
metadata:
  url: https://docs.flutter.dev/packages-and-plugins/developing-packages#types
...
for example the [`fluro`](https://pub.dev/packages/fluro)
package.
...
A concrete example is the [`url_launcher`](https://pub.dev/packages/url_launcher)
plugin package.
...
[Create an FFI package](/platform-integration/bind-native-code)).
...
( [Android](/platform-integration/android/c-interop), [iOS](/platform-integration/ios/c-interop),
[macOS](/platform-integration/macos/c-interop)). These packages are created
...
The [unit tests](/testing/overview#unit-tests) for the package.
...
To test the package, add [unit tests](/testing/overview#unit-tests)
in a `test` directory.


For additional details on how to organize the
package contents,
see the [Dart library package](https://dart.dev/guides/libraries/create-library-packages)
documentation.
...
implementation(s) using a [platform channel](/platform-integration/platform-channels).
...
`android`, `ios`, `web`, `linux`, `macos`, and
`windows`.
...
Open the main `hello/` folder in your favorite [Flutter editor](/tools/editors).
...
4. In the **Android Gradle Plugin Update** dialog,
...
1. Launch Xcode.
2. Select **File > Open**, and select the
...
on Flutter's [`main` channel](/install/upgrade#switching-flutter-channels).
...
check out [Privacy manifest files](https://developer.apple.com/documentation/bundleresources/privacy_manifest_files)
...
3. Choose **Yes** in the prompt asking:
...
2. Select **Open a project or solution**, and select the
...
This is done using a [platform channel](/platform-integration/platform-channels),
...
check out [Flutter in plugin tests](/testing/plugins-in-tests).


## Developing legacy FFI plugin packages
...
3. A [`LICENSE`](#adding-licenses-to-the-license-file) file containing the terms under which the package
    is licensed
...
2. Tell the documentation tool where the
...
on pub.dev are designated as [Flutter Favorites](https://pub.dev/flutter/favorites)?
...
To learn more,
see the [Flutter Favorites program](/packages-and-plugins/favorites).


Once you have implemented a package, you can publish it on
[pub.dev](https://pub.dev), so that other developers can easily use it.
...
[publishing docs](https://dart.dev/tools/pub/publishing) on dart.dev.
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.38.6. Page last updated on 2025-12-23. [View source](https://github.com/flutter/website/blob/main/src/content/packages-and-plugins/developing-packages.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/packages-and-plugins/developing-packages&page-source=https://github.com/flutter/website/blob/main/src/content/packages-and-plugins/developing-packages.md "Report an issue with this page").